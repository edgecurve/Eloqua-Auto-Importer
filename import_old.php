...
// IMPORTNATING AN EMAIL IN ELOQUA VIA THE API
		...
		if(!$resp) {
			  ...
			  echo ' -  Oops we did not get a responce from eloqua. This normally indicates one of two things. 1. You\'re simply not connected to the internet. OR 2. Your Authorization credentials are out of date or inaccurate. Good luck!  ';
			curl_close($ch);	
